...
const MenuDisplay = ({ menuItems, onAddToCart, searchTerm, onSearch }) => {
  ...
  return (
    <section className="px-6 py-10 max-w-7xl mx-auto space-y-12">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 mb-12 md:mb-20 pt-10">
        <div className="flex-1 text-center lg:text-left">
          ...
          >
            <span className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary border border-primary/20 text-[10px] md:text-xs font-bold uppercase tracking-[2px] mb-6">
              Welcome to the future of dining
            </span>
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-black text-white leading-tight mb-6 md:mb-8">
              Craving Something <br />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-primary via-purple-400 to-blue-500">Extraordinary?</span>
            </h2>
            <p className="text-paragraph text-base md:text-lg lg:text-xl max-w-2xl mx-auto lg:mx-0 mb-8 md:mb-10 leading-relaxed">
        ...
        <motion.div 
          className="hidden lg:block flex-1 relative min-h-[500px] lg:h-[600px] w-full"
        ...
        >
          <div className="relative w-full h-full perspective-1000">
            ...
            <motion.div 
               className="absolute top-0 left-16 w-64 h-80 rounded-[40px] overflow-hidden border-4 border-white/5 shadow-2xl z-20"
               animate={{ y: [-10, 10, -10] }}
            ...
            {/* 2. Pizza (Top Right) */}
            <motion.div 
               className="absolute top-[-20px] right-10 w-60 h-60 rounded-[35px] overflow-hidden border-4 border-white/5 shadow-2xl z-10"
            ...
            <motion.div 
               className="absolute bottom-20 right-4 w-56 h-56 rounded-[35px] overflow-hidden border-4 border-white/5 shadow-2xl z-10"
            ...
            <motion.div 
               className="absolute bottom-0 left-32 w-72 h-72 rounded-[45px] overflow-hidden border-4 border-white/5 shadow-2xl z-30"
               animate={{ y: [15, -15, 15] }}
